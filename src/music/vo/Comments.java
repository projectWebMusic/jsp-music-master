...
public class Comments implements Serializable {
	...
	int commentId;		// ID bình luận
	int userId;			// ID người dùng bình luận
	int songId;			// ID bài hát đã bình luận
	String commentText;	// bình luận
	Date commentDate;	// ngày bình luận
