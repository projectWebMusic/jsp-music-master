					...
					<div class="col-md-offset-3 col-md-6">
						...
						<section class="toolbar">
							<div class="btn-group" role="group">
								<button type="button" id="play" class="btn btn-primary"><span class="fa fa-headphones"></span>&nbsp;Nghe</button>
								<c:if test="${sessionScope.login_flag==login_success}">
									<a href="SongServlet?info=follow&songId=${requestScope.songInfo.song.songId }&userId=${sessionScope.user.userId }" type="button" class="btn btn-default"><span class="fa fa-heart-o"></span>&nbsp;Sưu tầm</a>
								</c:if>
									...
									<c:forEach items="${requestScope.songInfo.comments }" var="comment">
										<li class="media">
											...
											<c:if test="${sessionScope.admin_login_flag==login_success}">
												<a href="#" class="pull-right">Đăng xuất</a>
											</c:if>
										</li>
									</c:forEach>
								</ul>
