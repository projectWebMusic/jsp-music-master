						...
						<section class="description">
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="album-info">Xuất bản:<span class="date"><c:out value="${requestScope.albumInfo.album.albumPubDate }"></c:out></span></div>
									<div class="album-info">Nhà xuất bản:<span class="company"><c:out value="${requestScope.albumInfo.album.albumPubCom }"></c:out></span></div>
								</div>
							</div>
						</section>
						...
						<section class="toolbar">
							<div class="btn-group" role="group">
								<c:if test="${sessionScope.login_flag==login_success}">
									<a href="AlbumServlet?info=follow&albumId=${requestScope.albumInfo.album.albumId }&userId=${sessionScope.user.userId }" type="button" class="btn btn-default"><span class="fa fa-heart-o"></span>&nbsp;Giống</a>
								</c:if>
