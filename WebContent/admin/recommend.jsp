...
<html>
	<head>
		...
		<title>Bài hát được đề xuất</title>
	...
	<body>
		...
		<div class="container">
			<div class="form">
				<h2 class="theme-color">Bài hát được đề xuất</h2>
				<div class="row">
					<div class="col-md-8">
						<h3>Khuyến Khích</h3>
					...
					<div class="col-md-4">
						...
						<form action="<%=contextPath %>/RecommendServlet?info=add" method="post" class="form-horizontal">
							<table class="table">
								...
								<tr>
									<td colspan="2"><button type="submit" class="btn btn-primary">Thêm vào</button></td>
								</tr>
							</table>
						</form>
						<h3>Xóa bài hát</h3>
						<form action="<%=contextPath %>/RecommendServlet?info=remove" method="post" class="form-horizontal">
							<table class="table">
								<tr>
									<td><label class="control-label">ID được đề xuất</label></td>
