...
<html>
	...
	<body>
		<div class="container">
			<div class="form">
				<h2 class="theme-color">Theo dõi Albm</h2>
					...
					<table class="table table-striped">
						...
						<c:forEach items="${list }" var="normalUserAlbum" varStatus="status">
							<tr>
								...
								<td><a href="<%=contextPath %>/AlbumServlet?info=removeFollow&albumId=${normalUserAlbum.album.albumId}">Đăng xuất</a></td>
							</tr>
