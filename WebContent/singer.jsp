			...
			<div class="container">
				<div class="row">
					<div class="col-md-offset-2 col-md-8">
						...
						<section class="toolbar">
							<div class="btn-group" role="group">
								<c:if test="${sessionScope.login_flag==login_success}">
									<a href="SingerServlet?info=follow&singerId=${requestScope.singerInfo.singer.singerId }&userId=${sessionScope.user.userId }" type="button" class="btn btn-default"><span class="fa fa-heart-o"></span>&nbsp;Giống</a>
								</c:if>
							</div>
						</section>
						...
						<section class="hot">
							<h2 class="theme-color">Đánh đơn</h2>
